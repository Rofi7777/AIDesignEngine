...
export const modelTryOns = pgTable("model_try_ons", {
  ...
  scenarioCustom: varchar("scenario_custom", { length: 255 }),
  location: varchar("location", { length: 100 }),
  locationCustom: varchar("location_custom", { length: 255 }),
  presentationStyle: varchar("presentation_style", { length: 100 }),
  presentationStyleCustom: varchar("presentation_style_custom", { length: 255 }),
