...
export default function PosterDesign() {
  ...
  const generateMutation = useMutation({
    ...
    onSuccess: (data) => {
      ...
      toast({
        title: t("posterDesign.successTitle"),
        description: t("posterDesign.successMessage"),
      });
    },
    onError: (error: Error) => {
      toast({
        title: t("posterDesign.errorTitle"),
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="space-y-4">
          <div className="mb-6">
            ...
            <p className="text-muted-foreground">{t("posterDesign.subtitle")}</p>
          </div>
            ...
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
              ...
              <Card>
                <CardContent className="pt-6">
                  <Label>{t("posterDesign.productImages")} *</Label>
                  <div className="mt-2 space-y-2">
                    ...
                    <p className="text-xs text-muted-foreground">
                      {t("posterDesign.productImagesHint")}
                    </p>
                ...
                <AccordionItem value="module-a">
                  ...
                  <AccordionContent className="space-y-4 pt-4">
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          <FormLabel>{t("posterDesign.campaignType")} *</FormLabel>
                    ...
                    {form.watch("campaignType") === "custom" && (
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            <FormLabel>{t("posterDesign.customCampaign")}</FormLabel>
                            <FormControl>
                    ...
                    <div>
                      <Label>{t("posterDesign.referenceImage")}</Label>
                      <Input
                    ...
                    {referenceImage && (
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            <FormLabel>{t("posterDesign.referenceLevel")}</FormLabel>
                            <Select onValueChange={field.onChange} value={field.value}>
                              <FormControl>
                                <SelectTrigger>
                                  <SelectValue />
                ...
                <AccordionItem value="module-b">
                  ...
                  <AccordionContent className="space-y-4 pt-4">
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          <FormLabel>{t("posterDesign.visualStyle")} *</FormLabel>
                          <Select onValueChange={field.onChange} value={field.value}>
                            <FormControl>
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          <FormLabel>{t("posterDesign.backgroundScene")} *</FormLabel>
                          <Select onValueChange={field.onChange} value={field.value}>
                            <FormControl>
                              <SelectTrigger>
                                <SelectValue />
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          <FormLabel>{t("posterDesign.layout")} *</FormLabel>
                          <Select onValueChange={field.onChange} value={field.value}>
                            <FormControl>
                              <SelectTrigger>
                                <SelectValue />
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          <FormLabel>{t("posterDesign.aspectRatio")} *</FormLabel>
                          <Select onValueChange={field.onChange} value={field.value}>
                            <FormControl>
                              <SelectTrigger>
                                <SelectValue />
                ...
                <AccordionItem value="module-c">
                  ...
                  <AccordionContent className="space-y-4 pt-4">
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          <FormLabel>{t("posterDesign.headlineStyle")} *</FormLabel>
                          <Select onValueChange={field.onChange} value={field.value}>
                            <FormControl>
                              <SelectTrigger>
                                <SelectValue />
                    ...
                    {!form.watch("autoGenerateHeadline") && (
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            <FormLabel>{t("posterDesign.customHeadline")}</FormLabel>
                            <FormControl>
                    ...
                    <div className="space-y-2">
                      <Label>{t("posterDesign.sellingPoints")}</Label>
                      <FormField
                        control={form.control}
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          <FormLabel>{t("posterDesign.priceStyle")}</FormLabel>
                          <Select onValueChange={field.onChange} value={field.value}>
                            <FormControl>
                              <SelectTrigger>
                                <SelectValue />
                    ...
                    {form.watch("priceStyle") && form.watch("priceStyle") !== "no-price" && (
                      <>
                        <FormField
                          ...
                          render={({ field }) => (
                            <FormItem>
                              <FormLabel>{t("posterDesign.originalPrice")}</FormLabel>
                              <FormControl>
                        ...
                        <FormField
                          ...
                          render={({ field }) => (
                            <FormItem>
                              <FormLabel>{t("posterDesign.currentPrice")}</FormLabel>
                              <FormControl>
                        ...
                        <FormField
                          ...
                          render={({ field }) => (
                            <FormItem>
                              <FormLabel>{t("posterDesign.discountText")}</FormLabel>
                              <FormControl>
                    ...
                    <div>
                      <Label>{t("posterDesign.logoImage")}</Label>
                      <Input
                        ref={logoInputRef}
                        type="file"
                        accept="image/*"
                    ...
                    {logoImage && (
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            <FormLabel>{t("posterDesign.logoPosition")}</FormLabel>
                            <Select onValueChange={field.onChange} value={field.value}>
                              <FormControl>
                                <SelectTrigger>
                                  <SelectValue />
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          <FormLabel>{t("posterDesign.brandTagline")}</FormLabel>
                          <FormControl>
              ...
              >
                {generateMutation.isPending ? (
                  <>
                    ...
                    {t("posterDesign.generating")}
                  </>
                ) : (
                  t("posterDesign.generate")
                )}
              </Button>
            </form>
          </Form>
              ...
              {generatedPoster ? (
                <div className="space-y-4">
                  ...
                  >
                    ...
                    {t("posterDesign.download")}
                  </Button>
                </div>
              ) : (
                <div className="text-center text-muted-foreground p-8">
                  <Upload className="mx-auto h-12 w-12 mb-4 opacity-50" />
                  <p>{t("posterDesign.noPreview")}</p>
                </div>
              )}
            </CardContent>
          </Card>
